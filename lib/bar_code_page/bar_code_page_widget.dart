...
import 'bar_code_page_model.dart';
export 'bar_code_page_model.dart';
    ...
    return Title(
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              backgroundColor: Color(0xEB181E1F),
            ...
            body: SafeArea(
              ...
              child: Stack(
                children: [
                                                ...
                                                child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          0.0),
                                                  child: Image.asset(
                                                    'assets/images/barcodetm-04.png',
                                                    width: 320.0,
                                                    height: 200.0,
                                                    fit: BoxFit.contain,
                                                    alignment:
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: Image.asset(
                                                'assets/images/googlepaybutton-01.png',
                                                width: 120.0,
                                                height: 50.0,
                                                fit: BoxFit.contain,
                                              ),
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    30.0, 0.0, 30.0, 0.0),
                                            child: Text(
                                              '4 of ${FFAppConstants.numberOfTickets}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    30.0, 0.0, 30.0, 0.0),
                                            child: Text(
                                              '5 of ${FFAppConstants.numberOfTickets}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    30.0, 0.0, 30.0, 0.0),
                                            child: Text(
                                              '6 of ${FFAppConstants.numberOfTickets}',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 37.0, 190.0, 0.0),
                    child: Container(
                      width: 230.0,
                      height: 5.0,
                      decoration: BoxDecoration(
